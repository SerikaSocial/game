...
public sealed partial class ApiClient
{
    ...
    public async Task<JsonElement> GetGameMeAsync(string instanceId) =>
        await GetAuthedAsync($"/v1/games/{instanceId}/me");
    ...
    public async Task<JsonElement> GetGameStateAsync(string instanceId) =>
        await GetAuthedAsync($"/v1/games/{instanceId}/state");

    public async Task<JsonElement> CompleteTaskAsync(string instanceId) =>
    ...
    public async Task<JsonElement> ReportFinishAsync(string instanceId) =>
